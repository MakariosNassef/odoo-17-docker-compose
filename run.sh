...
git clone --depth=1 https://github.com/MakariosNassef/odoo-17-docker-compose $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: Odo017# | Live chat port: $CHAT"
